        ...
        <div className="max-w-2xl">
          ...
          <div className="mt-9 flex flex-col gap-4 sm:flex-row">
            <a
              ...
              className="flex items-center justify-center gap-2.5 rounded-sm bg-gold px-7 py-4 text-sm font-bold text-green-deep hover:bg-gold-light transition-colors"
            >
            ...
            <a
              href={telHref(phone)}
              className="flex items-center justify-center gap-2.5 rounded-sm border border-cream/40 px-7 py-4 text-sm font-bold text-cream hover:border-gold hover:text-gold transition-colors"
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
