        ...
        <div className="mt-12 grid gap-7 sm:grid-cols-2 lg:grid-cols-3">
          {testimonials.map((t, i) => (
            <Reveal key={t.id} delay={i * 100}>
              <div className="rounded border border-gold/25 bg-cream/5 p-8 transition-all duration-300 hover:-translate-y-1 hover:border-gold/50 hover:bg-cream/10">
        ...
        {googleReviewLink && (
          <div className="mt-8 text-center">
            <a
              ...
              className="inline-flex items-center gap-2.5 rounded-sm border border-gold/40 px-6 py-3 text-sm font-bold text-gold transition-all hover:scale-[1.03] hover:bg-gold/10"
            >
