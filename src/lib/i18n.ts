  ...
  const dict = {
    ru: {
      ...
      testimonials: {
        ...
        writeReviewToggle: "Или оставьте отзыв прямо здесь",
        formName: "Ваше имя",
        formCountry: "Откуда вы",
        formRating: "Оценка",
        formPhoto: "Добавить фото",
        formPhotoChange: "Заменить фото",
        formPhotoUploading: "Загрузка…",
        formText: "Ваш отзыв",
        formSubmit: "Отправить отзыв",
        formSending: "Отправка…",
        formSuccess: "Спасибо! Отзыв отправлен и появится на сайте после проверки.",
        formError: "Не получилось отправить. Попробуйте ещё раз.",
      },
      faq: {
    ...
    az: {
      ...
      testimonials: {
        ...
        writeReviewToggle: "Və ya rəyinizi birbaşa burada yazın",
        formName: "Adınız",
        formCountry: "Haradansınız",
        formRating: "Qiymətləndirmə",
        formPhoto: "Şəkil əlavə et",
        formPhotoChange: "Şəkli dəyiş",
        formPhotoUploading: "Yüklənir…",
        formText: "Rəyiniz",
        formSubmit: "Rəyi göndər",
        formSending: "Göndərilir…",
        formSuccess: "Təşəkkürlər! Rəyiniz göndərildi, yoxlanıldıqdan sonra saytda görünəcək.",
        formError: "Göndərmək mümkün olmadı. Yenidən cəhd edin.",
      },
      faq: {
    ...
    en: {
      ...
      testimonials: {
        ...
        writeReviewToggle: "Or leave a review right here",
        formName: "Your name",
        formCountry: "Where you're from",
        formRating: "Rating",
        formPhoto: "Add a photo",
        formPhotoChange: "Change photo",
        formPhotoUploading: "Uploading…",
        formText: "Your review",
        formSubmit: "Submit review",
        formSending: "Sending…",
        formSuccess: "Thank you! Your review has been submitted and will appear on the site after moderation.",
